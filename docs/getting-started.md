...
- Development Guide (development.txt) - Learn how to customize Axon
- Training Guide (training.txt) - Train your ML model on collected data
- Architecture (architecture.txt) - Understand how Axon works

TROUBLESHOOTING

If something isn't working, check the Troubleshooting Guide (troubleshooting.txt).
